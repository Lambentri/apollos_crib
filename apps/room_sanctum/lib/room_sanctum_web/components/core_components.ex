defmodule RoomSanctumWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    <div
      ...
      class="relative z-50 hidden modal modal-bottom md:modal-middle fade-in"
    >
      <div id={"#{@id}-bg"} class="bg-zinc-50/90 fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        class="fixed inset-0 overflow-y-auto fade-in-scale bg-base-100 modal-open opacity-80"
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-primary p-14 shadow-lg ring-1 transition"
            >
  ...
  attr :prompt, :string, default: "Choose a value", doc: "the prompt for select inputs"
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-primary-content">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 text-primary-content focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def header(assigns) do
    ...
    <header class={[@actions != [] && "flex items-center justify-between gap-6", @class]}>
      <div>
        <h1 class="text-3xl font-bold text-accent mx-4 py-2">
          <%= render_slot(@inner_block) %>
        </h1>
        <p :if={@subtitle != []} class="text-2xl font-bold text-accent-300 mx-4 py-2">
          ...
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="">
            ...
            >
              <div class="block py-4 pr-6">
                ...
                <span class={["", i == 0 && "ml-4 font-semibold"]}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RoomSanctumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RoomSanctumWeb.Gettext, "errors", msg, opts)
    end
  end
